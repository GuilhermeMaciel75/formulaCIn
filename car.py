...
class Player():
    ...
    def controle(self):
        ...
        if tecla[self.esquerda]:
            ...
            self.carro = pg.image.load(os.path.join('images','carro_esquerda.png'))
            

        if tecla[self.direita]:

            self.x += self.velocidade 
            self.carro = pg.image.load(os.path.join('images','carro_direita.png'))


        if tecla[self.cima]:
            
            self.y -= self.velocidade
            self.carro = pg.image.load(os.path.join('images','carro_cima.png'))


        if tecla[self.baixo]:

            self.y += self.velocidade
            self.carro = pg.image.load(os.path.join('images','carro_baixo.png'))
...
def main():
    ...
    carro = pg.image.load(os.path.join('images','carro_direita.png'))
